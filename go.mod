module github.com/codelaboratoryltd/nexus
...
// Use vitrifi's fork of go-ds-crdt with CLSet extensions
replace github.com/ipfs/go-ds-crdt => github.com/vitrifi/go-ds-crdt v0.0.0-20250723154949-025bd0bdbf37
